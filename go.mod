...
require (
	...
	github.com/klauspost/cpuid/v2 v2.2.6 // Спеки проца
	github.com/panjf2000/ants/v2 v2.9.0 // Пул горутин
	...
	golang.org/x/net v0.21.0 // Получение кодировки из строки с названием
